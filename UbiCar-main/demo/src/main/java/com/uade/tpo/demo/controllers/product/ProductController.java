...
public class ProductController {
    ...
    @GetMapping("obtener/productosDisponiblesRango")
    public List<ProductResponse> getAvailableProductsBetweenDates(
        @RequestParam LocalDate startDate,
        @RequestParam LocalDate endDate
    ) {
        return productService.getAvailableProductsBetweenDates(startDate, endDate);
    }
...
public ResponseEntity<ProductResponse> updateProductDeleted(
        @PathVariable Long id,
        @RequestBody ProductDeleteRequest request) {
    return ResponseEntity.ok(productService.updateProductDeleted(id, request));
}
